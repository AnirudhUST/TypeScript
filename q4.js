"use strict";
/*4.
Implement a TypeScript program to create a to-do list. The program should have a class for the to-do item that includes a description,
due date, and completion status.
The program should allow the user to add, remove, and complete items from the list. */
